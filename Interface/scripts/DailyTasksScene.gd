...
func _on_enter_mission1_pressed():
	...
	get_tree().change_scene_to_file("res://scenes-framework/Mission1Scene.tscn")
...
func _on_enter_mission3_pressed():
	...
	get_tree().change_scene_to_file("res://scenes-framework/Mission3Scene.tscn")

func _on_enter_mission4_pressed():
	# Change to Mission 4 scene
	get_tree().change_scene_to_file("res://scenes-framework/Mission4Scene.tscn")
